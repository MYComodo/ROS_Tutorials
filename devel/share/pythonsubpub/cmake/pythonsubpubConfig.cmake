...
if("TRUE" STREQUAL "TRUE")
  set(pythonsubpub_SOURCE_PREFIX /home/komodo/Desktop/Projects/ROS/ros_ws/src/pythonsubpub)
  set(pythonsubpub_DEVEL_PREFIX /home/komodo/Desktop/Projects/ROS/ros_ws/devel)
  ...
  set(pythonsubpub_INSTALL_PREFIX /home/komodo/Desktop/Projects/ROS/ros_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pythonsubpub' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/komodo/Desktop/Projects/ROS/ros_ws/src/pythonsubpub/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT pythonsubpub_NUM_DUMMY_TARGETS)
      set(pythonsubpub_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::pythonsubpub::wrapped-linker-option${pythonsubpub_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR pythonsubpub_NUM_DUMMY_TARGETS "${pythonsubpub_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::pythonsubpub::wrapped-linker-option${pythonsubpub_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND pythonsubpub_LIBRARIES "${interface_target_name}")
...
set(pythonsubpub_EXPORTED_TARGETS "")
